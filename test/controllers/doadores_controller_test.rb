...
class DoadoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create doador" do
    assert_difference('Doador.count') do
      post doadores_url, params: { doador: { bairro: @doador.bairro, cep: @doador.cep, cidade: @doador.cidade, email: @doador.email, endereco: @doador.endereco, numero: @doador.numero, telefone: @doador.telefone, uf: @doador.uf } }
    end
  ...
  test "should update doador" do
    patch doador_url(@doador), params: { doador: { bairro: @doador.bairro, cep: @doador.cep, cidade: @doador.cidade, email: @doador.email, endereco: @doador.endereco, numero: @doador.numero, telefone: @doador.telefone, uf: @doador.uf } }
